...
# ============================================================================
# ADDITION FOR ASSIGNMENT: setup_database() function
# ============================================================================
def setup_database(db_path: str = "support.db"):
    """
    Simplified setup function for assignment use.
    Creates database, tables, and inserts sample data automatically.
    
    This function is added to work with the assignment's main.py and agent code.
